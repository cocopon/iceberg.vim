...
function! s:create_context() abort
  ...
  call add(links, pgmnt#hi#link('jsDestructuringBlock', 'Identifier'))
  call add(links, pgmnt#hi#link('jsExport', 'Statement'))
  call add(links, pgmnt#hi#link('jsFuncArgs', 'Identifier'))
  ...
  call add(links, pgmnt#hi#link('jsTemplateExpression', 'Special'))
  call add(links, pgmnt#hi#link('jsVariableDef', 'Identifier'))
