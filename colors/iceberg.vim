...
if &background == 'light'
  hi Normal ctermbg=234 ctermfg=252 guibg=#e8e9ec guifg=#33374c
  hi ColorColumn cterm=NONE ctermbg=235 ctermfg=NONE guibg=#dcdfe7 guifg=NONE
  hi CursorColumn cterm=NONE ctermbg=235 ctermfg=NONE guibg=#dcdfe7 guifg=NONE
  hi CursorLine cterm=NONE ctermbg=235 ctermfg=NONE guibg=#dcdfe7 guifg=NONE
  hi Comment ctermfg=242 guifg=#8389a3
  hi Conceal ctermfg=242 guifg=#8389a3
  hi Constant ctermfg=140 guifg=#7759b4
  hi Cursor ctermbg=252 ctermfg=234 guibg=#33374c guifg=#e8e9ec
  hi CursorLineNr cterm=NONE ctermbg=237 ctermfg=253 guibg=#cad0de guifg=#576a9e
  hi Delimiter ctermfg=252 guifg=#33374c
  hi DiffAdd ctermbg=29 ctermfg=158 guibg=#d4dbd1 guifg=#475946
  hi DiffChange ctermbg=23 ctermfg=159 guibg=#ced9e1 guifg=#375570
  hi DiffDelete cterm=NONE ctermbg=95 ctermfg=224 gui=NONE guibg=#e3d2da guifg=#70415e
  hi DiffText cterm=NONE ctermbg=30 ctermfg=195 gui=NONE guibg=#acc5d3 guifg=#33374c
  hi Directory ctermfg=109 guifg=#3f83a6
  hi Error ctermbg=234 ctermfg=203 guibg=#e8e9ec guifg=#cc517a
  hi ErrorMsg ctermbg=234 ctermfg=203 guibg=#e8e9ec guifg=#cc517a
  hi WarningMsg ctermbg=234 ctermfg=203 guibg=#e8e9ec guifg=#cc517a
  hi EndOfBuffer ctermbg=234 ctermfg=236 guibg=#e8e9ec guifg=#cbcfda
  hi NonText ctermbg=234 ctermfg=236 guibg=#e8e9ec guifg=#cbcfda
  hi SpecialKey ctermbg=234 ctermfg=236 guibg=#e8e9ec guifg=#cbcfda
  hi Folded ctermbg=235 ctermfg=245 guibg=#dcdfe7 guifg=#788098
  hi FoldColumn ctermbg=235 ctermfg=239 guibg=#dcdfe7 guifg=#9fa7bd
  hi Function ctermfg=110 guifg=#2d539e
  hi Identifier cterm=NONE ctermfg=109 guifg=#3f83a6
  hi Ignore ctermbg=NONE ctermfg=NONE guibg=NONE guifg=NONE
  hi Include ctermfg=110 guifg=#2d539e
  hi IncSearch cterm=reverse ctermfg=NONE gui=reverse guifg=NONE term=reverse
  hi LineNr ctermbg=235 ctermfg=239 guibg=#dcdfe7 guifg=#9fa7bd
  hi MatchParen ctermbg=237 ctermfg=255 guibg=#bec0c9 guifg=#33374c
  hi ModeMsg ctermfg=242 guifg=#8389a3
  hi MoreMsg ctermfg=150 guifg=#668e3d
  hi Operator ctermfg=110 guifg=#2d539e
  hi Pmenu ctermbg=236 ctermfg=251 guibg=#cad0de guifg=#33374c
  hi PmenuSbar ctermbg=236 ctermfg=NONE guibg=#cad0de guifg=NONE
  hi PmenuSel ctermbg=240 ctermfg=255 guibg=#a7b2cd guifg=#33374c
  hi PmenuThumb ctermbg=251 ctermfg=NONE guibg=#33374c guifg=NONE
  hi PreProc ctermfg=150 guifg=#668e3d
  hi Question ctermfg=150 guifg=#668e3d
  hi QuickFixLine ctermbg=236 ctermfg=252 guibg=#c9cdd7 guifg=#33374c
  hi Search ctermbg=216 ctermfg=234 guibg=#eac6ad guifg=#85512c
  hi SignColumn ctermbg=235 ctermfg=239 guibg=#dcdfe7 guifg=#9fa7bd
  hi Special ctermfg=150 guifg=#668e3d
  hi SpellBad ctermbg=95 ctermfg=252 gui=undercurl guifg=NONE guisp=#cc517a
  hi SpellCap ctermbg=24 ctermfg=252 gui=undercurl guifg=NONE guisp=#2d539e
  hi SpellLocal ctermbg=23 ctermfg=252 gui=undercurl guifg=NONE guisp=#3f83a6
  hi SpellRare ctermbg=97 ctermfg=252 gui=undercurl guifg=NONE guisp=#7759b4
  hi Statement ctermfg=110 gui=NONE guifg=#2d539e
  hi StatusLine cterm=reverse ctermbg=234 ctermfg=245 gui=reverse guibg=#e8e9ec guifg=#757ca3 term=reverse
  hi StatusLineTerm cterm=reverse ctermbg=234 ctermfg=245 gui=reverse guibg=#e8e9ec guifg=#757ca3 term=reverse
  hi StatusLineNC cterm=reverse ctermbg=238 ctermfg=233 gui=reverse guibg=#8b98b6 guifg=#cad0de
  hi StatusLineTermNC cterm=reverse ctermbg=238 ctermfg=233 gui=reverse guibg=#8b98b6 guifg=#cad0de
  hi StorageClass ctermfg=110 guifg=#2d539e
  hi String ctermfg=109 guifg=#3f83a6
  hi Structure ctermfg=110 guifg=#2d539e
  hi TabLine cterm=NONE ctermbg=233 ctermfg=238 gui=NONE guibg=#cad0de guifg=#8b98b6
  hi TabLineFill cterm=reverse ctermbg=238 ctermfg=233 gui=reverse guibg=#8b98b6 guifg=#cad0de
  hi TabLineSel cterm=NONE ctermbg=234 ctermfg=252 gui=NONE guibg=#e8e9ec guifg=#606374
  hi TermCursorNC ctermbg=242 ctermfg=234 guibg=#8389a3 guifg=#e8e9ec
  hi Title ctermfg=216 gui=NONE guifg=#c57339
  hi Todo ctermbg=234 ctermfg=150 guibg=#d4dbd1 guifg=#668e3d
  hi Type ctermfg=110 gui=NONE guifg=#2d539e
  hi Underlined cterm=underline ctermfg=110 gui=underline guifg=#2d539e term=underline
  hi VertSplit cterm=NONE ctermbg=233 ctermfg=233 gui=NONE guibg=#cad0de guifg=#cad0de
  hi Visual ctermbg=236 ctermfg=NONE guibg=#c9cdd7 guifg=NONE
  hi VisualNOS ctermbg=236 ctermfg=NONE guibg=#c9cdd7 guifg=NONE
  hi WildMenu ctermbg=255 ctermfg=234 guibg=#32364c guifg=#e8e9ec
  hi diffAdded ctermfg=150 guifg=#668e3d
  hi diffRemoved ctermfg=203 guifg=#cc517a
  hi ALEErrorSign ctermbg=235 ctermfg=203 guibg=#dcdfe7 guifg=#cc517a
  hi ALEWarningSign ctermbg=235 ctermfg=216 guibg=#dcdfe7 guifg=#c57339
  hi ALEVirtualTextError ctermfg=203 guifg=#cc517a
  hi ALEVirtualTextWarning ctermfg=216 guifg=#c57339
  hi CtrlPMode1 ctermbg=241 ctermfg=234 guibg=#999eb6 guifg=#e8e9ec
  hi EasyMotionShade ctermfg=239 guifg=#3d425b
  hi EasyMotionTarget ctermfg=150 guifg=#668e3d
  hi EasyMotionTarget2First ctermfg=216 guifg=#c57339
  hi EasyMotionTarget2Second ctermfg=216 guifg=#c57339
  hi GitGutterAdd ctermbg=235 ctermfg=150 guibg=#dcdfe7 guifg=#668e3d
  hi GitGutterChange ctermbg=235 ctermfg=109 guibg=#dcdfe7 guifg=#3f83a6
  hi GitGutterChangeDelete ctermbg=235 ctermfg=109 guibg=#dcdfe7 guifg=#3f83a6
  hi GitGutterDelete ctermbg=235 ctermfg=203 guibg=#dcdfe7 guifg=#cc517a
  hi gitmessengerEndOfBuffer ctermbg=235 ctermfg=239 guibg=#dcdfe7 guifg=#9fa7bd
  hi gitmessengerPopupNormal ctermbg=235 ctermfg=252 guibg=#dcdfe7 guifg=#33374c
  hi Sneak ctermbg=140 ctermfg=234 guibg=#7759b4 guifg=#e8e9ec
  hi SneakScope ctermbg=236 ctermfg=242 guibg=#c9cdd7 guifg=#8389a3
  hi SyntasticErrorSign ctermbg=235 ctermfg=203 guibg=#dcdfe7 guifg=#cc517a
  hi SyntasticStyleErrorSign ctermbg=235 ctermfg=203 guibg=#dcdfe7 guifg=#cc517a
  hi SyntasticStyleWarningSign ctermbg=235 ctermfg=216 guibg=#dcdfe7 guifg=#c57339
  hi SyntasticWarningSign ctermbg=235 ctermfg=216 guibg=#dcdfe7 guifg=#c57339
  hi ZenSpace ctermbg=203 guibg=#cc517a
  hi icebergALAccentRed ctermfg=203 guifg=#cc517a
