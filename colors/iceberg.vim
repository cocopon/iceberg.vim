...
hi! TabLineFill cterm=reverse ctermbg=234 ctermfg=245 gui=reverse guibg=#17171b guifg=#1e2132
hi! TabLineSel cterm=NONE ctermbg=234 ctermfg=252 gui=NONE guibg=#2a3158 guifg=#cdd1e6
